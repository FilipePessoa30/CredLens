...
- It does not generate data for any scenario except `baseline` - see `docs/synthetic_generation_implementation.md` for what's actually implemented as of Phase 4A, and `docs/synthetic_generation_spec.md` for the full six-scenario design.
