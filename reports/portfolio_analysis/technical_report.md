...
_Real public data, kept completely separate from the synthetic operational analysis above - never merged, never treated as a CredLens result._
...
## 11. Limitations
- Every result comes from a synthetic DGP; see docs/assumptions_and_limitations.md.
