"""Credit Funnel page - thin entrypoint, see
`credlens.dashboard.pages.render_credit_funnel` for the composition logic."""
...
from credlens.dashboard.pages import render_credit_funnel
...
render_credit_funnel(st.session_state["credlens_data"], state)
