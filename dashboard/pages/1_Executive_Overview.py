"""Executive Overview page - thin entrypoint, see
`credlens.dashboard.pages.render_executive_overview` for the actual
composition logic."""
...
from credlens.dashboard.pages import render_executive_overview
...
render_executive_overview(st.session_state["credlens_data"], state)
