"""Cure, Collections & Recovery page - thin entrypoint, see
`credlens.dashboard.pages.render_cure_collections_recovery` for the composition logic."""
...
from credlens.dashboard.pages import render_cure_collections_recovery
...
render_cure_collections_recovery(st.session_state["credlens_data"], state)
