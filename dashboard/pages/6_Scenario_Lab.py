"""Scenario Lab page - thin entrypoint, see
`credlens.dashboard.pages.render_scenario_lab` for the composition logic."""
...
from credlens.dashboard.pages import render_scenario_lab
...
render_scenario_lab(st.session_state["credlens_data"], state)
